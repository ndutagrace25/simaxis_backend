...
router.post("/attach/meter", verifyToken_1.default, customer_1.default.attachMeterToCustomer);
router.get("/landlord/tenants/:landlord_id", verifyToken_1.default, customer_1.default.getLandlordTenants);
